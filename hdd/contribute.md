...
<form class="hdd-contrib-form" id="hydrogen-contribution-form" action="https://formspree.io/f/xjgawgej" method="POST" novalidate>
  ...
  <div class="hdd-contrib-local">
    <label><input type="checkbox" id="hdd-local-mode" title="Generate JSON locally without sending a submission." checked /> Local test mode (do not submit)</label>
    <label><input type="checkbox" id="hdd-skip-validation" title="Skip row validation checks when generating JSON." /> Skip validation checks</label>
