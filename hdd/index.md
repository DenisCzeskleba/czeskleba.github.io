  ...
  <div class="hdd-control hdd-filter-grid hdd-filter-scroll">
    ...
    <div id="hdd-advanced-filters" class="hdd-advanced-filters" hidden>
      ...
      <div class="hdd-panel-footer">
        ...
        <button
          type="button"
          id="hdd-legacy-db-button"
          class="hdd-data-status hdd-legacy-db-button"
          title="Experimental feature: upload a custom or legacy database JSON. Use Ctrl+F5 (or F5) to reload the default database."
        >
          Upload Database
        </button>
        <input id="hdd-legacy-db-file" type="file" accept=".json,application/json" hidden />
      </div>
    </aside>
          ...
          <div class="hdd-stage-controls">
            ...
            <details class="hdd-plot-options hdd-plot-options-primary">
              ...
              <div class="hdd-plot-options-body">
                <div class="hdd-toggle-group" role="group" aria-label="Temperature units">
                  <button type="button" data-unit="K" title="Show temperature in Kelvin.">&deg;K</button>
                ...
                <div class="hdd-axis-mode-panel" hidden>
                  ...
                  <div class="hdd-toggle-group" role="group" aria-label="Axis temperature behavior">
                ...
                <div class="hdd-plot-axis">
                  <div class="hdd-axis-group" id="hdd-axis-x-group">
                ...
                <label class="hdd-inline-checkbox" id="hdd-envelope-row" title="Shade the uncertainty or scatter band.">
                  <input type="checkbox" id="hdd-envelope" checked />
                  <span>Envelope fill</span>
                </label>
                <label class="hdd-inline-checkbox" id="hdd-force-scatterband-row" title="Force the Boellinghaus scatterband into the current plot view. This disables automatic scaling while active. Turn it off before further filtering.">
                ...
                <div class="hdd-axis-label">Import/Export Settings</div>
                <div class="hdd-toggle-group hdd-settings-row">
                  <button type="button" id="hdd-import-settings" title="Import saved settings. After clicking, paste a full settings URL or raw hash into the popup input field. Applies filters, plot options, axis settings, and zoom.">
                    Import
                  </button>
                  <button type="button" data-download="settings" title="Export current settings as a shareable URL. Copies to clipboard when possible (otherwise shown in a copy prompt).">
                    Export
                  </button>
                </div>
              </div>
            ...
            <details class="hdd-plot-options hdd-export-panel" data-order="export">
              ...
              <div class="hdd-plot-options-body">
                ...
                <div class="hdd-export-note">Data/Authors</div>
                <div class="hdd-export-row">
                  <button type="button" data-download="csv" title="Export plotted data table (all visible plotted samples).">CSV</button>
                  <button type="button" data-download="txt" title="Export full filtered source list as: No. Author Year.">TXT</button>
                </div>
...
<div class="hdd-summary-modal" id="hdd-summary-modal" aria-hidden="true">
  ...
  <div class="hdd-summary-panel" role="dialog" aria-label="Filtered Series">
    <div class="hdd-summary-panel-header">
      <span id="hdd-summary-modal-title">Filtered Series</span>
