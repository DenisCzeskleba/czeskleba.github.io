...
<div class="hdd-page-hero">
  <img class="hdd-hero-logo" src="/assets/Membrane Diffusion Analyser.png" alt="Membrane Diffusion Analyzer logo" decoding="async" loading="lazy" />
  <div class="hdd-hero-text">
    <h1>Membrane Diffusion Analyzer</h1>
    <p>A local-first scaffold for permeation transient analysis. The page shell is in place so we can wire in file upload, classical evaluation, inverse Fick checks, exports, and diagnostics without waiting for deployment.</p>
  </div>
</div>
