      ...
      <div class="mda-panel-body">
        ...
        <section class="mda-section">
          ...
          <div class="mda-control" style="margin-top:0.75rem;">
            ...
            <input id="mda-t0-offset" type="range" min="-100" max="100" step="0.1" value="0" title="Set the start time offset. Negative values remove early time; positive values prepend baseline time." />
